        ...
        <div className="lg:flex  justify-center gap-6 mt-14">
          ...
          <div className="lg:w-1/2 w-full space-y-3">
            ...
            <p className="leading-[26px] ">
              Hi, I'm Mohammad Sajeeb, a passionate full-stack web developer who
              thrives on building seamless, user-friendly, and innovative web
              ...
              taking projects from concept to completion, ensuring every detail
              aligns with your goals. My skills include designing intuitive user
              interfaces, developing efficient APIs, and implementing scalable,
              secure back-end systems. Whether it's crafting responsive designs
              or optimizing complex database structures, I focus on delivering
              solutions that meet modern web standards. Collaboration is at the
              heart of my process. I work closely with clients and teams to
              understand their needs, adapt to challenges, and ensure the end
              product exceeds expectations. With a commitment to continuous
              learning, I stay updated on the latest technologies to bring fresh
              ideas to every project. Let's create something amazing together!
            </p>
          </div>
        </div>
      </div>
